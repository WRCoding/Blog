...
CREATE TABLE `blog_article_image`  (
  ...
  `modified_by` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '这张表用来保存题图url，每一篇文章都应该有题图' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `blog_article_info` VALUES (3, 'ssm搭建博客', 1, '2019-07-17 21:56:19', '2019-09-29 10:30:01', 0);
INSERT INTO `blog_article_info` VALUES (4, 'springmvc+mybatis+sping搭建博客', 0, '2018-07-17 22:03:07', '2019-09-28 12:39:10', 0);
INSERT INTO `blog_article_info` VALUES (5, 'SpringBoot', 0, '2018-07-19 16:12:30', '2019-09-28 12:39:12', 0);
INSERT INTO `blog_article_info` VALUES (6, 'admitLet', 11, '2019-07-19 17:05:49', '2019-09-30 07:59:59', 0);
INSERT INTO `blog_article_info` VALUES (7, 'springboot-使用editor.md及使用阿里云OSS作图床', 0, '2017-07-20 09:50:53', '2019-09-28 12:39:30', 0);
INSERT INTO `blog_article_info` VALUES (8, '测试图片的显示', 0, '2019-07-21 10:13:19', '2019-09-28 12:39:30', 0);
INSERT INTO `blog_article_info` VALUES (9, '测试测试测试啊', 0, '2017-07-27 10:56:53', '2019-09-28 12:39:30', 0);
INSERT INTO `blog_article_info` VALUES (10, 'LeetCode', 0, '2019-08-11 22:22:36', '2019-09-28 12:39:30', 0);
INSERT INTO `blog_article_info` VALUES (11, 'sd阿萨大', 0, '2017-09-13 15:35:07', '2019-09-28 12:38:33', 1);
INSERT INTO `blog_article_info` VALUES (15, '更新后的十大弟弟', 0, '2019-09-13 16:24:59', '2019-09-28 12:39:30', 0);
INSERT INTO `blog_article_info` VALUES (16, 'PDD', 3, '2019-09-15 19:49:19', '2019-09-29 10:30:01', 0);
INSERT INTO `blog_article_info` VALUES (17, '谈谈Redis', 3, '2019-09-29 14:34:55', '2019-09-30 07:59:59', 0);
INSERT INTO `blog_article_info` VALUES (18, '林北', 4, '2019-09-29 14:44:26', '2019-09-30 07:59:59', 0);
...
CREATE TABLE `blog_user`  (
  ...
  `login_user_name` varchar(255) CHARACTER SET  utf8 COLLATE  utf8_general_ci NULL DEFAULT NULL COMMENT '登录名',
...
-- ----------------------------
INSERT INTO `blog_user` VALUES (1, 'admin', '$2a$10$2GUI.ArknQlbg2Jte4XAkOc/8bqQWTDT6lOuqi7vSgglmey7q1bh2', '林北', 'ADMIN');
